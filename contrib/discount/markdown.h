...
int  mkd_compile(Document *, mkd_flag_t);
int  mkd_document(Document *, char **);
int  mkd_generatehtml(Document *, FILE *);
int  mkd_css(Document *, char **);
int  mkd_generatecss(Document *, FILE *);
...
void mkd_string_to_anchor(char*,int, mkd_sta_function_t, void*, int, MMIOT *);

Document *mkd_in(FILE *, mkd_flag_t);
Document *mkd_string(const char*, int, mkd_flag_t);

Document *gfm_in(FILE *, mkd_flag_t);
Document *gfm_string(const char*,int, mkd_flag_t);

void mkd_initialize();
void mkd_shlib_destructor();

void mkd_ref_prefix(Document*, char*);
...
void ___mkd_freefootnote(Footnote *);
...
void ___mkd_reparse(char *, int, mkd_flag_t, MMIOT*, char*);
void ___mkd_emblock(MMIOT*);
void ___mkd_tidy(Cstring *);

Document *__mkd_new_Document();
void __mkd_enqueue(Document*, Cstring *);
void __mkd_trim_line(Line *, int);

int  __mkd_io_strget(struct string_stream *);
